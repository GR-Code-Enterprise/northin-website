function historyCarousel()
{
    ...
    const infoMarca = document.querySelector(".history__container__right__carousel__info__marca")
    const infoCliente = document.querySelector(".history__container__right__carousel__cliente")
    const infoCTA = document.querySelector(".history__container__right__carousel__cta")
